...
class AWSShellDriver(ResourceDriverInterface):
    ...
    def create_app_image(self, context, cancellation_context, ports, delete_old_image='False', app_template_name='', revertNum='1'):
        return self.aws_shell.create_app_image(context, cancellation_context, delete_old_image == 'True', app_template_name, int(revertNum))
